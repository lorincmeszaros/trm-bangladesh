...
pcr.report(pcrelev, r'p:\11208012-011-nabaripoma\Model\Python\results\dummy\maps\elevation.map')
pcrfloodelev = pcr.numpy2pcr(pcr.Scalar, elevmat, -999.)
pcr.report(pcrfloodelev, r'p:\11208012-011-nabaripoma\Model\Python\results\dummy\maps\floodelevation.map')
#create ldd
pcr.setglobaloption('lddin')
pcr.setglobaloption('unittrue')
pcrldd = pcr.lddcreate(pcrelev,9999999,9999999,9999999,9999999)
pcr.report(pcrldd, r'p:\11208012-011-nabaripoma\Model\Python\results\dummy\maps\ldd.map')
...
pcr.report(pcrdist2riv,r'p:\11208012-011-nabaripoma\Model\Python\results\dummy\maps\dist2riv.map')
...
pcr.report(pcrdist2sea,r'p:\11208012-011-nabaripoma\Model\Python\results\dummy\maps\dist2sea.map')
